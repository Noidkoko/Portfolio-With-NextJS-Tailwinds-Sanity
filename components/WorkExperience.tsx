...
export default function WorkExperience({ experiences }: Props) {
  return (
    ...
    className="relative flex h-screen overflow-hidden flex-col text-left md:flex-row max-w-full px-10 justify-evenly mx-auto items-center">
        ...
        <div className="absolute top-24 crollbar scrollbar-track-gray-400/20 scrollbar-thumb-[gold]/80 w-full flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory">
            {/* Experiences Cards */}
